...
class WaypointsControllerTest < ActionController::TestCase
  ...
  test "should create waypoint" do
    assert_difference('Waypoint.count') do
      post :create, waypoint: { latitude: @waypoint.latitude, longitude: @waypoint.longitude, name: @waypoint.name }
    end
  ...
  test "should update waypoint" do
    patch :update, id: @waypoint, waypoint: { latitude: @waypoint.latitude, longitude: @waypoint.longitude, name: @waypoint.name }
    assert_redirected_to waypoint_path(assigns(:waypoint))
  end
